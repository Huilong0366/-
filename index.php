...
<head>
    <title>吃掉金丝虾球</title>
    <meta itemprop="name" content="吃掉金丝虾球" />
    <meta itemprop="description" content="阿晴饿了" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
            ...
            <div id="GameScoreLayer-score" style="margin:10px 0;">吃掉了</div>
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/Huilong0366/Eat-Golden-Shrimp-Balls'">开源</button>
        </div>
    </div>
    </div>
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">阿晴饿了</div><br />
